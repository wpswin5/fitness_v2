...
CREATE TABLE [dbo].[ProgramWorkouts] (
    ...
    [WorkoutId] UNIQUEIDENTIFIER NULL, -- Null if rest day
    [WeekNumber] INT NOT NULL, -- Which week (1 to DurationWeeks)
    [DayOfWeek] INT NOT NULL, -- 0-6 (0=Sunday, 6=Saturday)
    [IsRestDay] BIT NOT NULL DEFAULT 0, -- If true, no workout scheduled
